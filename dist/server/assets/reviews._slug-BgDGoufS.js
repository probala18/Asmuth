...
import { c as SplitTextReveal, s as ScrollProgressBar, u as TiltCard } from "./motion-CSNJjo3r.js";
import { t as Route } from "./reviews._slug-Cr7lxfIC.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Award, Check, ExternalLink, Star, X } from "lucide-react";
//#region src/routes/reviews.$slug.tsx?tsr-split=component
			...
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-radial-glow opacity-60" }), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "size-3.5 group-hover:-translate-x-1 transition-transform" }), "Back to Reviews"]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-3 mb-6",
						children: [/* @__PURE__ */ jsx(Award, { className: "size-4 text-[var(--emerald-accent)]" }), /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsx(Star, { className: `size-4 ${i < Math.floor(review.overallScore / 2) ? "fill-current text-[var(--emerald-accent)]" : "text-muted"}` }, i))
						}), /* @__PURE__ */ jsxs("p", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
						...
						product && /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
									...
									children: ["Buy on Amazon ", /* @__PURE__ */ jsx(ExternalLink, { className: "size-3.5" })]
								})]
							})
						})
					]
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							className: "space-y-6",
							children: review.scores.map((score) => /* @__PURE__ */ jsx(ScrollProgressBar, {
								label: score.label,
								value: score.value
							}, score.label))
						})]
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						className: "space-y-3",
						children: review.pros.map((p) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3 text-sm leading-relaxed",
							children: [/* @__PURE__ */ jsx(Check, { className: "size-4 text-[var(--emerald-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ jsx("span", { children: p })]
						}, p))
					})]
				}), /* @__PURE__ */ jsxs("div", {
					className: "surface-card-2 p-8 rounded-3xl border border-[var(--hairline)]",
					children: [/* @__PURE__ */ jsx("p", {
						...
						className: "space-y-3",
						children: review.cons.map((p) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3 text-sm leading-relaxed",
							children: [/* @__PURE__ */ jsx(X, { className: "size-4 text-[var(--cyan-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ jsx("span", { children: p })]
						}, p))
					})]
				})]
			})
		}),
		comparison && /* @__PURE__ */ jsx("section", {
			className: "px-6 lg:px-10 py-16",
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: comparison.specs.map((spec, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: spec.label
							}), spec.values.map((v, idx) => /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: relatedReviews.map((r) => /* @__PURE__ */ jsx(TiltCard, {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
									...
									children: [/* @__PURE__ */ jsxs("span", { children: ["By ", r.author] }), /* @__PURE__ */ jsx("span", { children: r.readTime })]
								})]
							})]
						})
					}, r.slug))
