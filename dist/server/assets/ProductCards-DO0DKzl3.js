import { i as useSavedProducts, r as toggleSavedProduct } from "./saved-products-CUi3zrcj.js";
import { a as MouseGlow, u as TiltCard } from "./motion-CSNJjo3r.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import * as Icons from "lucide-react";
import { ArrowRight, Bookmark, BookmarkCheck, GitCompareArrows, Star, Tag, Timer } from "lucide-react";
import { motion } from "motion/react";
//#region src/components/site/ProductCards.tsx
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						hasDiscount && !product.badge && /* @__PURE__ */ jsxs("span", {
						...
						/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Star, { className: "size-3 text-amber-400 fill-amber-400" }), product.rating.toFixed(1)]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(GitCompareArrows, { className: "size-4" })
							}), /* @__PURE__ */ jsx("button", {
								type: "button",
								...
								children: isSaved ? /* @__PURE__ */ jsx(BookmarkCheck, { className: "size-4" }) : /* @__PURE__ */ jsx(Bookmark, { className: "size-4" })
							})]
						})
					]
				}), /* @__PURE__ */ jsxs(Link, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Timer, { className: "size-3 text-[var(--emerald-accent)]" }), /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsx(motion.div, {
		...
		children: /* @__PURE__ */ jsxs(TiltCard, {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-background via-background/90 to-background/55" }),
				/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: "Explore" }), /* @__PURE__ */ jsx(motion.span, {
							variants: {
								initial: { x: 0 },
								hover: { x: 3 }
							},
							...
							children: /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5" })
						})]
					})]
				})
			]
