...
import { AlertCircle, CheckCircle, Mail, MapPin, MessageCircle, Send } from "lucide-react";
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-radial-glow opacity-70" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("p", {
					...
					children: ["Concierge, editorial, partnerships. We ", /* @__PURE__ */ jsx(HandUnderline, { children: "actually respond." })]
				})
			]
		})]
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(it.Icon, { className: "size-5 text-[var(--emerald-accent)]" })
				...
				children: [submitStatus === "success" && /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(CheckCircle, { className: "size-16 text-[var(--success)] mb-6 animate-bounce" }),
						/* @__PURE__ */ jsx("h3", {
					...
					className: "space-y-4",
					children: [
						submitStatus === "error" && /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-[var(--danger)] text-sm",
							children: [/* @__PURE__ */ jsx(AlertCircle, { className: "size-5 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "An error occurred while sending your message. Please try again." })]
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", { children: [
							...
							errors.message && /* @__PURE__ */ jsxs("p", {
								className: "text-xs text-[var(--danger)] mt-1.5 flex items-center gap-1",
								children: [
									/* @__PURE__ */ jsx(AlertCircle, { className: "size-3.5" }),
									" ",
									errors.message
								]
							})
						...
						/* @__PURE__ */ jsx("button", {
							...
							children: isSubmitting ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", { className: "animate-spin inline-block size-4 border-2 border-current border-t-transparent rounded-full" }), "Sending..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Send, { className: "size-4" }), " Send message"] })
						})
					]
				})]
			})]
