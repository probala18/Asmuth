...
//#region src/components/site/motion.tsx
...
function SplitTextReveal({ text, className = "", as = "h1", delay = 0, stagger = .08 }) {
	...
	return createElement(as, {
		ref,
		className
	}, words.map((w, i) => /* @__PURE__ */ jsx("span", {
		"data-word": true,
...
function JourneyLine({ steps }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("svg", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				className: "relative",
				children: /* @__PURE__ */ jsx("span", { className: "absolute left-1/2 -translate-x-1/2 top-2 size-3 rounded-full bg-[var(--emerald-accent)] glow-emerald" })
