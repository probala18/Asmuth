  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const scrollTween = gsap.to(nav, {
        ...
        backgroundColor: "rgba(var(--surface-rgb, 15, 23, 42), 0.85)",
    ...
    <>
      ...
      <header className="fixed top-0 inset-x-0 z-40 px-4 sm:px-8 pt-4 pointer-events-none">
        <motion.div
          ...
          className="max-w-7xl mx-auto rounded-full border border-[var(--hairline)] bg-[var(--surface)]/70 backdrop-blur-xl px-5 py-2.5 transition-all shadow-lg pointer-events-auto flex items-center justify-between gap-4"
        >
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <span className="hidden lg:inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[var(--surface-2)] text-[10px] font-mono-tech uppercase tracking-widest text-[var(--emerald-accent)] border border-[var(--hairline)]">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <motion.button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-full surface-card text-xs text-muted-foreground hover:text-foreground border border-[var(--hairline)] transition-all"
            >
              <Search className="size-3.5" />
              <span className="hidden sm:inline">Search</span>
              <kbd className="hidden lg:inline-flex items-center gap-0.5 text-[9px] font-mono-tech text-muted-foreground bg-[var(--surface-2)] px-1.5 py-0.5 rounded">
                ⌘K
              </kbd>
            </motion.button>
            ...
            <Link to="/wishlist">
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full surface-card text-xs font-medium text-foreground border border-[var(--hairline)] transition-all hover:border-[var(--emerald-accent)]"
              >
                <Bookmark className="size-3.5 text-[var(--emerald-accent)]" />
                <span className="hidden sm:inline">Saved</span>
                <span className="inline-flex items-center justify-center size-4 rounded-full bg-[var(--emerald-accent)]/20 text-[10px] font-mono-tech text-[var(--emerald-accent)]">
            ...
            <div className="relative">
              <motion.button
                ...
                className="relative p-2 rounded-full surface-card text-foreground border border-[var(--hairline)] hover:border-[var(--emerald-accent)] transition-all"
              >
            ...
            <div className="relative">
              <motion.button
                ...
                className="flex items-center gap-2 p-1 pl-1.5 pr-2.5 rounded-full surface-card border border-[var(--hairline)] hover:border-[var(--emerald-accent)] transition-all"
              >
                <div className="size-6 rounded-full overflow-hidden bg-[var(--surface-2)] border border-[var(--hairline)] shrink-0">
                  <img
