...
export const products: Product[] = [
  {
    ...
    specs: [
      ...
      { label: "Battery", value: "9.4h (ANC on)" },
      { label: "Codec", value: "LDAC, AAC, SBC" },
      { label: "Weight", value: "5.2g per bud" },
      { label: "Water Rating", value: "IP55" },
    ],
    pros: ["Flattest frequency response in category", "ANC without pressure", "9.4h battery with ANC — best in class", "Multipoint connection"],
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Sensors", value: "SpO2, ECG, Temp" },
      { label: "Case", value: "Grade 5 Titanium" },
      { label: "Water Rating", value: "10ATM" },
      { label: "Weight", value: "36g without band" },
    ],
    pros: ["72-hour battery — best in class", "Medical-grade vitals tracking", "Titanium build at consumer price", "Always-on AMOLED"],
  ...
  },
  {
    ...
    pros: ["22-hour battery — unmatched", "OLED display with 120Hz", "Completely silent under load", "Best-in-class keyboard"],
    cons: ["Only 2 USB-C ports", "No headphone jack", "RAM not upgradeable"],
    isTrending: true,
    isBestSeller: true,
    isEditorsPick: true,
  ...
  },
  {
    ...
    pros: ["Computational photography rivals mirrorless", "120Hz LTPO feels seamless", "65W charging: 0-80% in 25 min", "Clean software, no bloat"],
    cons: ["No expandable storage", "Ultra-wide could be sharper", "No 3.5mm jack"],
    isTrending: true,
  ...
  },
  {
    ...
    reviewCount: 1523,
    image: "/assets/product-laptop.jpg",
    badge: "best-value" as Product["badge"],
    ...
    pros: ["Pro-tier display at consumer price", "M-class chip handles anything", "Pen 2 latency is class-leading", "All-day battery"],
    cons: ["Base model only 256GB", "No headphone jack", "Keyboard sold separately"],
    isBestSeller: true,
  ...
  },
  {
    ...
    specs: [
      { label: "Sensor", value: "Full-frame 61MP" },
      ...
      { label: "Weight", value: "658g body only" },
    ],
    pros: ["8K recording is stunning", "AI autofocus is near-perfect", "Best-in-class EVF", "Weather-sealed build"],
    cons: ["Premium pricing", "Battery life could be better for video", "Large file sizes at 8K"],
    isEditorsPick: true,
  ...
  },
  {
    ...
    specs: [
      { label: "Driver", value: "Planar magnetic 100mm" },
      { label: "Impedance", value: "300Ω" },
      { label: "Frequency", value: "5Hz - 50kHz" },
      { label: "Type", value: "Open-back" },
      { label: "Cable", value: "Detachable, balanced" },
      { label: "Weight", value: "380g" },
    ],
    pros: ["Ruler-flat frequency response", "Incredible soundstage", "Premium build quality", "Detachable balanced cable"],
    cons: ["Requires a dedicated amp", "Open-back leaks sound", "Not portable"],
  ...
  },
  {
    ...
    specs: [
      { label: "Protocols", value: "Thread, Matter, Zigbee" },
      { label: "WiFi", value: "Wi-Fi 6E" },
      { label: "Devices", value: "Up to 200" },
      { label: "Power", value: "USB-C, 5W" },
      { label: "Size", value: "68mm diameter" },
      { label: "Voice", value: "Alexa, Google, Siri" },
    ],
    pros: ["Universal protocol support", "Matter-ready from day one", "Tiny form factor", "Handles 200 devices"],
    cons: ["No built-in speaker", "Requires ethernet for best performance", "Basic app UI"],
    isTrending: true,
