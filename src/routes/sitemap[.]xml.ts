    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/products/laptop-air", changefreq: "weekly", priority: "0.7" },
          { path: "/reviews/macbook-pro", changefreq: "weekly", priority: "0.7" },
          { path: "/deals", changefreq: "weekly", priority: "0.6" },
          { path: "/best-of-2026", changefreq: "weekly", priority: "0.9" },
