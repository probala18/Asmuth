...
export const Route = createFileRoute("/dmca")({
  head: () => ({
    meta: [
      { title: "DMCA Notice — AETHER" },
      { name: "description", content: "Details on how to submit copyright and DMCA take-down notices to AETHER." },
    ],
  }),
  component: DmcaPage,
});
    ...
    <article className="max-w-4xl mx-auto px-6 lg:px-10 pt-40 pb-20 space-y-12">
      <div className="space-y-4">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          How to file copyright notices with AETHER. We respect intellectual property and respond promptly to legal claims.
        </p>
      </div>
      ...
      <div className="space-y-8 font-sans leading-relaxed text-foreground/80">
        <div className="space-y-3">
          ...
          <p>
            If you believe your copyrighted material is displayed on AETHER in a way that constitutes copyright infringement, you may submit a formal notification under the Digital Millennium Copyright Act.
          </p>
          <p>
          ...
          <ul className="list-disc list-inside pl-4 space-y-2 mt-2 text-sm text-muted-foreground">
            ...
            <li>The precise URL on AETHER containing the material you claim is infringing.</li>
        ...
        <div className="space-y-3">
          ...
          <p>
            Please send all copyright notices to our legal team via: <span className="font-mono font-semibold text-foreground">legal@aether.design</span>
          </p>
        </div>
      </div>
    </article>
