...
export const metadata = { title: "How We Review — genCART", description: "Our laboratory testing standards, benchmarks, and editorial guidelines." };
    ...
    <article className="max-w-4xl mx-auto px-6 lg:px-10 pt-40 pb-20 space-y-12">
      ...
      <div className="surface-card p-8 md:p-10 rounded-3xl border border-[var(--hairline)] space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            { step: "01", title: "Procurement", desc: "We buy products directly from retail stores. No free review samples, no developer hardware sent directly from PR teams." },
            { step: "02", title: "Lab Testing", desc: "Every product is benchmarked against its competitors in controlled environments. We measure battery run time, temperature under load, and sound output." },
            { step: "03", title: "Daily Driving", desc: "A member of our editorial staff takes the product home as their primary daily device for a minimum of 21 days." },
            { step: "04", title: "Scoring & Review", desc: "Our review scoring is entirely mathematical. Individual categories are weighted to calculate the final genCART Rating." },
          ].map((s) => (
