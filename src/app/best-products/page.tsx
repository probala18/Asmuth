                ...
                <div className="grid grid-cols-1 sm:grid-cols-[1.2fr_1.5fr] gap-6 items-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-2 flex flex-wrap gap-2">
                      <Link href={`/product/${topProduct.slug}`} className="btn-accent rounded-full px-4 py-2 text-xs font-semibold">
                        Specs & Pricing
                      </Link>
                      {runnerUp && (
                        <Link href={`/product/${runnerUp.slug}`} className="btn-ghost-glow rounded-full px-4 py-2 text-xs font-semibold">
