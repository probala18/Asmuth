...
import { s as Trash2, z as Eye } from "../_libs/lucide-react.mjs";
import { r as ProductCard } from "./ProductCards-DO0DKzl3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/recently-viewed-BjBWhEiy.js
...
function RecentlyViewedPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: historyItems.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "size-4" }), " Clear History"]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
				children: historyItems.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductCard, { product }, product.slug))
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "size-12 text-muted-foreground" }),
