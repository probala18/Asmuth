...
import { t as Route } from "./compare._slug-DKDeDVF7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/compare._slug-77Pq2f2T.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-radial-glow opacity-60" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "size-3.5 group-hover:-translate-x-1 transition-transform" }), "Back to Comparison Hub"]
					}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						comparison.winner === productA.slug && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "size-3" }), " Winner"]
						}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: [...Array(5)].map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: `size-3 ${i < Math.floor(productA.rating) ? "fill-amber-400 text-amber-400" : "text-muted"}` }, i))
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									children: ["Amazon ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3" })]
								})]
							})]
						})
					]
					...
					children: [
						comparison.winner === productB.slug && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "absolute top-4 right-4 bg-[var(--emerald-accent)] text-background text-[9px] font-bold font-mono-tech px-2.5 py-1 rounded-full uppercase tracking-wider flex items-center gap-1 shadow-md",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "size-3" }), " Winner"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex items-center gap-0.5",
											children: [...Array(5)].map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: `size-3 ${i < Math.floor(productB.rating) ? "fill-amber-400 text-amber-400" : "text-muted"}` }, i))
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "text-xs text-muted-foreground",
											children: [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Metric" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: productA.name }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: productB.name })
						]
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [valAObj?.value || "—", valAObj?.isWinner && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block ml-1.5 size-1.5 rounded-full bg-[var(--emerald-accent)]" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: `text-sm ${valBObj?.isWinner ? "text-[var(--emerald-accent)] font-semibold" : "text-foreground"}`,
									children: [valBObj?.value || "—", valBObj?.isWinner && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block ml-1.5 size-1.5 rounded-full bg-[var(--emerald-accent)]" })]
								})
							]
						}, i);
					})]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "space-y-2",
							children: productA.pros && productA.pros.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "flex items-start gap-2 text-xs text-muted-foreground leading-relaxed",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-[var(--emerald-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p })]
							}, p))
							...
							className: "space-y-2",
							children: productA.cons && productA.cons.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "flex items-start gap-2 text-xs text-muted-foreground leading-relaxed",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-3.5 text-[var(--cyan-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p })]
							}, p))
						})] })]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "space-y-2",
							children: productB.pros && productB.pros.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "flex items-start gap-2 text-xs text-muted-foreground leading-relaxed",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-[var(--emerald-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p })]
							}, p))
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "space-y-2",
							children: productB.cons && productB.cons.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "flex items-start gap-2 text-xs text-muted-foreground leading-relaxed",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-3.5 text-[var(--cyan-accent)] mt-0.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p })]
							}, p))
						})] })]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [comparison.winner && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
